...
/*if (Input.GetKeyDown(KeyCode.Q) && cooldown.IsReady())
{
    ...
    public GameObject AttachFlame(FireFlame fire)
    {
        ...
        {
            flamethrowerScript.SetStats(n, k);
        }          
